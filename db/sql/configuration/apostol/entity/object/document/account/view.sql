...
AS
  SELECT t.id, t.document,
         ...
         t.code, ot.label AS Name, ot.label, dt.description, b.amount AS Balance
...
CREATE OR REPLACE VIEW ObjectAccount (Id, Object, Parent,
  ...
  Code, Name, Label, Description, Balance,
...
AS
  SELECT t.id, d.object, o.parent,
         ...
         t.code, ot.label, ot.label, dt.description, b.amount,
    ...
    FROM db.account t INNER JOIN db.document          d ON t.document = d.id
