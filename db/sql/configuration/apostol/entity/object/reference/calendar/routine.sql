 ...
 * @throws IncorrectClassType - If type does not belong to 'calendar' class
 * @since 1.0.0
 */
...
--------------------------------------------------------------------------------
/**
 * @brief Returns a calendar identifier by code.
 * @param {text} pCode - Calendar code
 * @return {uuid} - Calendar identifier
 * @since 1.0.0
 */
...
--------------------------------------------------------------------------------
/**
 * @brief Adds a date entry to a calendar.
 * @param {uuid} pCalendar - Calendar identifier
 * @param {date} pDate - Date
 * @param {bit} pFlag - Day type flag (pre-holiday, holiday, weekend, non-working, working)
 ...
 * @param {interval[][]} pSchedule - Schedule intervals
 * @param {uuid} pUserId - User account identifier
 * @return {uuid} - Calendar date entry identifier
 * @since 1.0.0
 */
...
--------------------------------------------------------------------------------
/**
 * @brief Updates a calendar date entry.
 * @param {uuid} pId - Calendar date entry identifier
 * @param {uuid} pCalendar - Calendar identifier
 * @param {date} pDate - Date
 * @param {bit} pFlag - Day type flag
 * @param {interval} pWorkStart - Work day start time
 * @param {interval} pWorkCount - Working hours count
 * @param {interval} pRestStart - Break start time
 * @param {interval} pRestCount - Break hours count
...
--------------------------------------------------------------------------------
/**
 * @brief Returns a calendar date entry identifier.
 * @param {uuid} pCalendar - Calendar identifier
 * @param {date} pDate - Date
 * @param {uuid} pUserId - User account identifier
 * @return {uuid} - Calendar date entry identifier
 ...
 * @param {uuid} pUserId - User account identifier
 * @return {SETOF calendar_date} - Calendar date records
 * @since 1.0.0
 */
...
--------------------------------------------------------------------------------
/**
 * @brief Fills a calendar with dates for a given period.
 * @param {uuid} pCalendar - Calendar identifier
 * @param {date} pDateFrom - Period start date
 * @param {date} pDateTo - Period end date
 * @param {uuid} pUserId - User account identifier
 * @return {void}
 * @throws ObjectNotFound - If calendar does not exist
 * @since 1.0.0
 */
...
--------------------------------------------------------------------------------
/**
 * @brief Calculates the working time period between two dates using a calendar.
 * @param {uuid} pCalendar - Calendar identifier
 * @param {timestamptz} pDateFrom - Period start
 * @param {timestamptz} pDateTo - Period end
 * @param {uuid} pUserId - User account identifier
 * @return {interval} - Total working time in the period
 * @since 1.0.0
 */
