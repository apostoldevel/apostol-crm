...
--------------------------------------------------------------------------------
/**
 * @brief REST JSON API dispatcher for priority entity
 * @param {text} pPath - Request path ('/priority/count', '/priority/get', '/priority/list')
 * @param {jsonb} pPayload - Request payload with search/filter/pagination params
 * @return {SETOF json} - Response records as JSON
 * @throws RouteIsEmpty - When pPath is NULL
 * @throws LoginFailed - When no active session
 * @throws RouteNotFound - When pPath does not match any route
 * @since 1.0.0
 */
CREATE OR REPLACE FUNCTION rest.priority (
  pPath       text,
