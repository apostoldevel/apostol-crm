...
BEGIN
  ...
  SELECT code INTO l FROM db.locale WHERE id = current_locale();
  ...
  vHTML := vHTML || E'<body>\n';
  vHTML := vHTML || E'<div class="report-font-size">\n';
  ...
  IF l.code = 'ru' THEN
	...
	vHTML := vHTML || E'        <th class="ant-table-cell" style="width: 10%!important;">Статус</th>\n';
	vHTML := vHTML || E'        <th class="ant-table-cell" style="width: 10%!important;">Username</th>\n';
	vHTML := vHTML || E'        <th class="ant-table-cell" style="width: 10%!important;">Имя</th>\n';
	vHTML := vHTML || E'        <th class="ant-table-cell" style="width: 10%!important;">Почтовый адрес</th>\n';
	vHTML := vHTML || E'        <th class="ant-table-cell" style="width: 10%!important;">Телефон</th>\n';
	vHTML := vHTML || E'        <th class="ant-table-cell" style="width: 10%!important;">Описание</th>\n';
	vHTML := vHTML || E'        <th class="ant-table-cell" style="width: 10%!important;">Создан</th>\n';
	vHTML := vHTML || E'        <th class="ant-table-cell" style="width: 10%!important;">IP</th>\n';
	vHTML := vHTML || E'        <th class="ant-table-cell" style="width: 10%!important;">Дата входа</th>\n';
	vHTML := vHTML || E'        <th class="ant-table-cell" style="width: 5%!important;">Успешных</th>\n';
	vHTML := vHTML || E'        <th class="ant-table-cell" style="width: 5%!important;">Неудачных</th>\n';
	vHTML := vHTML || E'      </tr>\n';
  ELSE
	vHTML := vHTML || E'      <tr class="gx-text-center">\n';
	vHTML := vHTML || E'        <th class="ant-table-cell" style="width: 10%!important;">Status</th>\n';
	vHTML := vHTML || E'        <th class="ant-table-cell" style="width: 10%!important;">Username</th>\n';
	vHTML := vHTML || E'        <th class="ant-table-cell" style="width: 10%!important;">Name</th>\n';
	vHTML := vHTML || E'        <th class="ant-table-cell" style="width: 10%!important;">Email</th>\n';
	vHTML := vHTML || E'        <th class="ant-table-cell" style="width: 10%!important;">Phone</th>\n';
	vHTML := vHTML || E'        <th class="ant-table-cell" style="width: 10%!important;">Description</th>\n';
	vHTML := vHTML || E'        <th class="ant-table-cell" style="width: 10%!important;">Create</th>\n';
	vHTML := vHTML || E'        <th class="ant-table-cell" style="width: 10%!important;">IP</th>\n';
	vHTML := vHTML || E'        <th class="ant-table-cell" style="width: 10%!important;">Input last</th>\n';
	vHTML := vHTML || E'        <th class="ant-table-cell" style="width: 5%!important;">Input count</th>\n';
	vHTML := vHTML || E'        <th class="ant-table-cell" style="width: 5%!important;">Input error</th>\n';
	vHTML := vHTML || E'      </tr>\n';
  END IF;
  ...
  IF bEmpty THEN
	IF l.code = 'ru' THEN
	  vHTML := vHTML || E'        <tr class="gx-text-center">\n';
	  vHTML := vHTML || E'          <td class="ant-table-cell" colspan="11" scope="col">Нет данных</td>\n';
	  vHTML := vHTML || E'        </tr>\n';
	ELSE
	  vHTML := vHTML || E'        <tr class="gx-text-center">\n';
	  vHTML := vHTML || E'          <td class="ant-table-cell" colspan="11" scope="col">No data</td>\n';
	  vHTML := vHTML || E'        </tr>\n';
	END IF;
  END IF;
