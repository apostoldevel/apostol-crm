...
BEGIN
  ...
  IF l.code = 'ru' THEN
    ...
    vHTML := vHTML || E'        <th class="ant-table-cell" style="width: 10%!important;">Сессия</th>\n';
    vHTML := vHTML || E'        <th class="ant-table-cell" style="width: 10%!important;">Пользователь</th>\n';
    ...
    vHTML := vHTML || E'        <th class="ant-table-cell" style="width: 10%!important;">Дата создания</th>\n';
    vHTML := vHTML || E'        <th class="ant-table-cell" style="width: 10%!important;">Дата обновления</th>\n';
    vHTML := vHTML || E'        <th class="ant-table-cell" style="width: 10%!important;">Хост</th>\n';
    vHTML := vHTML || E'        <th class="ant-table-cell" style="width: 10%!important;">Статус</th>\n';
    vHTML := vHTML || E'      </tr>\n';
  ELSE
    vHTML := vHTML || E'      <tr class="gx-text-center">\n';
    vHTML := vHTML || E'        <th class="ant-table-cell" style="width: 10%!important;">Session</th>\n';
    ...
    vHTML := vHTML || E'        <th class="ant-table-cell" style="width: 10%!important;">Created</th>\n';
    vHTML := vHTML || E'        <th class="ant-table-cell" style="width: 10%!important;">Updated</th>\n';
    vHTML := vHTML || E'        <th class="ant-table-cell" style="width: 10%!important;">Host</th>\n';
