...
BEGIN
  ...
  uType := AddType(uClass, 'passive.account', 'Пассивный', 'Пассивный счёт.');
  PERFORM EditTypeText(uType, 'Passive', 'Passive account.', GetLocale('en'));

  uType := AddType(uClass, 'active-passive.account', 'Активно-пассивный', 'Активно-пассивный счёт.');
  PERFORM EditTypeText(uType, 'Active-passive', 'Active-Passive account.', GetLocale('en'));
