...
#include "Processes.hpp"  // create_processes()
...
class ApostolCRMApp final : public Application
{
public:
    ApostolCRMApp() : Application("apostol-crm") {}

protected:
    void create_custom_processes() override
    {
        create_processes(*this);   // see src/processes/Processes.hpp
    }
    ...
    void on_helper_start(EventLoop& loop) override
    {
        ...
        // Register all Helper modules (PGFetch, PGFile, etc.)
